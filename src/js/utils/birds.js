const birdsData = [
  ...
  [
    {
      ...
      description: {
        ...
        en: 'Sparrows are the most famous and recognizable birds. They are easily recognizable by their colorful plumage and perky chirping. Sparrows are a synatropic species - they settle close to human habitation.',
      },
    ...
    },
    {
      ...
      species: {
        ru: 'Corvus frugilegus',
        en: 'Corvus frugilegus',
      },
      description: {
        ...
        en: 'Rooks are very smart and quick-witted birds. With the help of a beak, they create and use the simplest tools. Rooks have a developed reflex to the sounds of a tractor. Hearing the “rattle”, they fly towards the sound – the tractor is plowing the ground, which means that there is a lot of food in this place.',
      },
    ...
    },
    {
      ...
      species: {
        ru: 'Turdus philomelos',
        en: 'Turdus philomelos',
      },
      description: {
        ...
        en: 'Drozd is the best singer of the sparrows. The song consists only of beautiful sonorous whistles and short trills. Most often it can be heard in the morning and evening. Thrushes sing during the entire nesting period.',
      },
    ...
    },
    {
      ...
      species: {
        ru: 'Garrulus glandarius',
        en: 'Garrulus glandarius',
      },
      description: {
        ...
        en: 'When a jay is worried, the tuft on her head is ruffled. The bird tries to create a frightening sight. Jays are able to imitate the voices of other birds, animals and the sounds that humans create. For the winter they store large stocks of acorns and nuts.',
      },
  ...
  [
    {
      ...
      species: {
        ru: 'Fringilla coelebs',
        en: 'Fringilla coelebs',
      },
      description: {
        ...
        en: 'There are 450 species of finches in the wild. In winter, finches lead a flocking lifestyle. Sometimes sparrows can be seen in their families. Finches sing in the spring, with the onset of the mating season. Their singing is a flooded multi-minute roulades.',
      },
    ...
    },
    {
      ...
      species: {
        ru: 'Loxia curvirostra',
        en: 'Loxia curvirostra',
      },
      description: {
        ...
        en: 'Klestov are called "Christmas" birds. Under natural conditions, they give birth in winter - in January. These birds insulate their nests with moss and animal hair, so the chicks are not cold. In search of cones crossbills can fly 3500 km from the nest.',
      },
    ...
    },
    {
      ...
      species: {
        ru: 'Streptopelia turtur',
        en: 'Streptopelia turtur',
      },
      description: {
        ...
        en: 'The turtle dove lives in mixed and broad-leaved forests, as well as in city parks and towns. Birds often choose places of life next to humans and easily get used to people. Due to the melodic pleasant singing of turtle doves, they are often bred at home.',
      },
    ...
    },
    {
      ...
      species: {
        ru: 'Dendrocopos major',
        en: 'Dendrocopos major',
      },
      description: {
    ...
    },
    {
      ...
      description: {
        ...
        en: 'Hoopoes prefer to live in open landscapes with individual trees or groves. The most convenient for the bird are the forest-steppe and savannah. A hoopoe can choose places of residence next to a person: pastures, vineyards, orchards.',
      },
    ...
    },
    {
      ...
      description: {
        ...
        en: 'The swift can be seen in almost every corner of the planet. They live both in forest areas and in open areas. Swifts live in large flocks. Large colonies of these birds can be seen in towns or on coastal cliffs.',
      },
  ...
  [
    ...
    },
    {
      ...
      species: {
        ru: 'Luscinia luscinia',
        en: 'Luscinia luscinia',
      },
      description: {
    ...
    },
    {
      ...
      description: {
        ...
        en: 'The melodiousness of the oriole"s voice is compared to the sound of a flute. It is difficult for a person to see the oriole, as it lives high in the trees. The oriole is not only a very beautiful, but also a useful bird. It destroys poisonous caterpillars that other birds do not eat.',
      },
  ...
  [
    ...
    },
    {
      ...
      description: {
        ...
        en: 'Lun is a small falcon. It feeds mainly on mouse-like rodents, the basis of its diet is voles, hamsters, and mice. The plumage of the Harrier may be ash grey. With such a bird is associated the comparison "gray-haired like a harrier".',
      },
    ...
    },
    {
      ...
      description: {
        ...
        en: 'The falcon"s Latin name, Falco, comes from the word "sickle" because of the crescent-shaped wings. Long and wide wings allow the falcon to rise high into the sky and soar freely. The falcon"s flight speed reaches 280-320 kilometers per hour.',
      },
    ...
    },
    {
      ...
      species: {
        ru: 'Accipiter gentilis',
        en: 'Accipiter gentilis',
      },
      description: {
  ...
  [
    {
      ...
      description: {
        ...
        en: 'The "Albatross" is the largest flying bird in the world. The wingspan reaches three and a half, weight - ten kilograms. Albatrosses spend most of their lives in the air, covering vast distances above the oceans.',
      },
    ...
    },
    {
      ...
      description: {
        ...
        en: 'The sizes of petrels are different. The smallest of them are up to 25 cm long, the largest - up to 1 m, with a wingspan of about 2 m. There is a belief that the appearance of a petrel in the air portends a storm, as the very name of the bird says.',
      },
    ...
    },
    {
      ...
      description: {
        ...
        en: 'Pelicans are inhabitants of the seas and rivers. They walk awkwardly, but fly and swim well. They feed mainly on fish, arrange collective hunts - lined up in a semicircle, they flap their wings and beaks on the water and force out the frightened fish in shallow water.',
      },
      image: 'https://ecoportal.info/wp-content/uploads/2019/09/pelikan-544x408.jpg',
    ...
    },
    {
      ...
      species: {
        ru: 'Aptenodytes forsteri',
        en: 'Aptenodytes forsteri',
      },
      description: {
        ...
        en: 'The male emperor penguin reaches a height of 130 cm and can weigh up to 50 kg. Of all modern penguins, this species is the largest. The penguin"s diet consists of fish, squid and krill. Birds hunt in large groups in the ocean.',
      },
    ...
    },
    {
      ...
      description: {
        ...
        en: 'Seagulls inhabit the shores of the seas, lakes, rivers, reservoirs, swamps, often nest on islands. Since the end of the last century, seagulls began to appear in large cities, where they nest on the roofs of buildings. All seagulls lead a colonial way of life.',
      },
